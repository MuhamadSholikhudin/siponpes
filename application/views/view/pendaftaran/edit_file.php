            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form role="form" action="<?= base_url("admin/pendaftaran/edit_file_aksi") ?>" id="register-form" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="hidden" class="form-control" id="id_daftar" name="id_daftar" value="<?= $daftar->id_daftar ?>" required >
                                        <input class="form-control" type="text" class="form-control" id="nama_lengkap"  value="<?= $daftar->nama_lengkap ?>" required placeholder="Nama Lengkap">
                                    </div>
                                </div>
