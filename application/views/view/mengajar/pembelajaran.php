...
error_reporting(0);
        ...
        ?>
            <form action="<?= base_url('ustads/mengajar/aksi_edit/') ?>" enctype="multipart/form-data" method="POST">
                ...
                <table class="table table-bordered table-striped table-hover js ">
                    <thead>
                        <tr class="tr_th">
                            <th>No</th>
                            <th>Nama</th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($tampil_siswa as $ts) : ?>
                            <tr class="tr_td">
                                ...
                                <td>
                                    <?php
                                                    $nama_lengkap = $this->db->query(" SELECT * FROM pendaftaran WHERE id_daftar =  $ts->id_daftar")->row();
                                                    ?>
                                ...
                                if ($cari_nilai->num_rows() > 0) {
                                    ...
                                    echo "<td><input type='hidden' name='id_nilai[]'
                                    value='" . $tampil_nilai->id_nilai . "' ><input type='number' name='nilai[]' value='" . $tampil_nilai->nilai . "' ></td>";
                                } else {
                                }
                                ?>
                            </tr>
