<section class="content">
    <div class="container-fluid">
        ...
        $cari_rapot_1 = $this->db->query("SELECT * FROM absensi JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal WHERE absensi.id_santri = $id_santri AND jadwal.id_kelas = 1 AND absensi.status = 1");
        $cari_rapot_2 = $this->db->query("SELECT * FROM absensi JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal WHERE absensi.id_santri = $id_santri AND jadwal.id_kelas = 2 AND absensi.status = 1");
        $cari_rapot_3 = $this->db->query("SELECT * FROM absensi JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal WHERE absensi.id_santri = $id_santri AND jadwal.id_kelas = 3 AND absensi.status = 1");
        $cari_rapot_4 = $this->db->query("SELECT * FROM absensi JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal WHERE absensi.id_santri = $id_santri AND jadwal.id_kelas = 4 AND absensi.status = 1");
        $cari_rapot_5 = $this->db->query("SELECT * FROM absensi JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal WHERE absensi.id_santri = $id_santri AND jadwal.id_kelas = 5  AND absensi.status = 1");
        ?>
        <?php
        ...
        ?>
            <div class="card">
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND  jadwal.id_kelas = 1 AND pelajaran.jenis = 'Materi' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran_p = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 1 AND pelajaran.jenis = 'Konsep dan Praktikum' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    ...
                    <a href="<?= base_url('santri/rapot/cetak_rapot/'.$id_santri.'/'.$kelas->id_kelas) ?>" target="_blank" class="btn bg-teal waves-effect"> 
        ...
        ?>
            <div class="card">
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 2 AND pelajaran.jenis = 'Materi' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran_p = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 2 AND pelajaran.jenis = 'Konsep dan Praktikum' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <?php
                    $cari_sikap = $this->db->query("SELECT COALESCE(AVG(ketaatan), 0) as ketaatan, COALESCE(AVG(ketakdiman), 0) as ketakdiman, COALESCE(AVG(kedisiplinan), 0) as kedisiplinan, COALESCE(AVG(kerapian), 0) as kerapian, COALESCE(AVG(kesemangatan), 0) as kesemangatan, COALESCE(AVG(partisipasi), 0) as partisipasi, COALESCE(AVG(etika), 0) as etika, COALESCE(AVG(kerjasama), 0) as kerjasama, COALESCE(AVG(kelengkapan_catatan), 0) as kelengkapan_catatan, COUNT(id_sikap_dan_prilaku) as banyak FROM sikap_dan_prilaku WHERE id_santri = $id_santri AND id_kelas = 2");
                    if ($cari_sikap->num_rows() > 0) {
                        $t_sikap = $cari_sikap->row();
                        $banyak = $t_sikap->banyak;
                        $ketaatan = ceil($t_sikap->ketaatan);
        ...
        ?>
            <div class="card">
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 3 AND pelajaran.jenis = 'Materi' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran_p = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 3 AND pelajaran.jenis = 'Konsep dan Praktikum' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <?php
                    $cari_sikap = $this->db->query("SELECT COALESCE(AVG(ketaatan), 0) as ketaatan, COALESCE(AVG(ketakdiman), 0) as ketakdiman, COALESCE(AVG(kedisiplinan), 0) as kedisiplinan, COALESCE(AVG(kerapian), 0) as kerapian, COALESCE(AVG(kesemangatan), 0) as kesemangatan, COALESCE(AVG(partisipasi), 0) as partisipasi, COALESCE(AVG(etika), 0) as etika, COALESCE(AVG(kerjasama), 0) as kerjasama, COALESCE(AVG(kelengkapan_catatan), 0) as kelengkapan_catatan, COUNT(id_sikap_dan_prilaku) as banyak FROM sikap_dan_prilaku WHERE id_santri = $id_santri AND id_kelas = 3");
                    if ($cari_sikap->num_rows() > 0) {
                        $t_sikap = $cari_sikap->row();
                        $banyak = $t_sikap->banyak;
                        $ketaatan = ceil($t_sikap->ketaatan);
        ...
        ?>
            <div class="card">
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 4 AND pelajaran.jenis = 'Materi' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran_p = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 4 AND pelajaran.jenis = 'Konsep dan Praktikum' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <?php
                    $cari_sikap = $this->db->query("SELECT COALESCE(AVG(ketaatan), 0) as ketaatan, COALESCE(AVG(ketakdiman), 0) as ketakdiman, COALESCE(AVG(kedisiplinan), 0) as kedisiplinan, COALESCE(AVG(kerapian), 0) as kerapian, COALESCE(AVG(kesemangatan), 0) as kesemangatan, COALESCE(AVG(partisipasi), 0) as partisipasi, COALESCE(AVG(etika), 0) as etika, COALESCE(AVG(kerjasama), 0) as kerjasama, COALESCE(AVG(kelengkapan_catatan), 0) as kelengkapan_catatan, COUNT(id_sikap_dan_prilaku) as banyak FROM sikap_dan_prilaku WHERE id_santri = $id_santri AND id_kelas = 4");
                    if ($cari_sikap->num_rows() > 0) {
                        $t_sikap = $cari_sikap->row();
                        $banyak = $t_sikap->banyak;
                        $ketaatan = ceil($t_sikap->ketaatan);
        ...
        ?>
            <div class="card">
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 5 AND pelajaran.jenis = 'Materi' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $tampil_pelajaran_p = $this->db->query("SELECT * FROM absensi LEFT JOIN jadwal ON absensi.id_jadwal = jadwal.id_jadwal JOIN pelajaran ON jadwal.id_pelajaran = pelajaran.id_pelajaran WHERE absensi.id_santri = $id_santri AND absensi.status = 1 AND jadwal.id_kelas = 5 AND pelajaran.jenis = 'Konsep dan Praktikum' GROUP BY pelajaran.id_pelajaran");
                            $no = 0;
                            $rata_rata = 0;
                            ?>
                            <?php
                ...
                <div class="body table-responsive">
                    <?php
                    $cari_sikap = $this->db->query("SELECT COALESCE(AVG(ketaatan), 0) as ketaatan, COALESCE(AVG(ketakdiman), 0) as ketakdiman, COALESCE(AVG(kedisiplinan), 0) as kedisiplinan, COALESCE(AVG(kerapian), 0) as kerapian, COALESCE(AVG(kesemangatan), 0) as kesemangatan, COALESCE(AVG(partisipasi), 0) as partisipasi, COALESCE(AVG(etika), 0) as etika, COALESCE(AVG(kerjasama), 0) as kerjasama, COALESCE(AVG(kelengkapan_catatan), 0) as kelengkapan_catatan, COUNT(id_sikap_dan_prilaku) as banyak FROM sikap_dan_prilaku WHERE id_santri = $id_santri AND id_kelas = 5");
                    if ($cari_sikap->num_rows() > 0) {
                        $t_sikap = $cari_sikap->row();
                        $banyak = $t_sikap->banyak;
                        $ketaatan = ceil($t_sikap->ketaatan);
