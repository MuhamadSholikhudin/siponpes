                                ...
                                <div class="modal-content">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            ...
                                            <div class="body">
                                                <form action="<?= base_url('admin/aksi_tambah_santri') ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($santri as $peng) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('admin/ubah_santri/' . $peng->id_santri) ?>" class="btn btn-warning waves-effect" type="button">
                                                        <i class="material-icons">edit</i>
                                                        <span>Edit</span>
                                                    </a>
                                                </td>
                                                <td><a href="<?= base_url('admin/hapus_santri/' . $peng->id_santri) ?>" class="btn btn-danger waves-effect" type="button">
