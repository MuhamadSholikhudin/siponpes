                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3">
                                <?php if ($this->session->userdata('level') == 1) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('level') == 3) { ?>
                                        <form action="<?= base_url('kadin/laporan/absensi_pertanggal') ?>" method="POST" enctype="multipart/form-data">
                                        <?php } ?>
                            ...
                            <div class="col-sm-3">
                                <?php if ($this->session->userdata('level') == 1) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('level') == 3) { ?>
                                        <form action="<?= base_url('kadin/laporan/absensi_perbulan') ?>" method="POST" enctype="multipart/form-data">
                                        <?php } ?>
                            ...
                            <div class="col-sm-3">
                                <?php if ($this->session->userdata('level') == 1) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('level') == 3) { ?>
                                        <form action="<?= base_url('kadin/laporan/absensi_pertahun') ?>" method="POST" enctype="multipart/form-data">
                                        <?php } ?>
