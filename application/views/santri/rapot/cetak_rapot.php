                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <tr>
                                            <th>
                                                <?php
                                                    $absen_masuk = $this->db->query("SELECT COUNT(status) as masuk FROM absensi WHERE id_santri = $id_santri[0] AND id_kelas = $kelas[0] AND status = 'Masuk' AND status = 1")->row();
                                                    echo $absen_masuk->masuk;
                                                ?>
                                            </th>
                                            <th>
                                                <?php
                                                    $absen_ijin = $this->db->query("SELECT COUNT(status) as ijin FROM absensi WHERE id_santri = $id_santri[0] AND id_kelas = $kelas[0] AND status = 'Ijin' AND status = 1")->row();
                                                    echo $absen_ijin->ijin;
                                                ?>
                                            </th>
                                            <th>
                                                <?php
                                                    $absen_sakit = $this->db->query("SELECT COUNT(status) as sakit FROM absensi WHERE id_santri = $id_santri[0] AND id_kelas = $kelas[0] AND status = 'Sakit' AND status = 1")->row();
                                            ...
                                            <th>
                                                <?php
                                                    $absen_alasan = $this->db->query("SELECT COUNT(status) as alasan FROM absensi WHERE id_santri = $id_santri[0] AND id_kelas = $kelas[0] AND status = 'Alasan' AND status = 1")->row();
