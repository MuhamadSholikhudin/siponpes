                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="number" id="id_sikap_dan_prilaku" name="id_sikap_dan_prilaku" value="<?= $sikap->id_sikap_dan_prilaku ?>" class="form-control" required>
                                            <input type="number" id="id_pelajaran" name="id_pelajaran" value="<?= $sikap->id_pelajaran ?>" class="form-control" required>
                                            <input type="number" id="kelas" name="kelas" value="<?= $sikap->id_kelas?>" class="form-control" required>
                                            <input type="number" id="id_santri" name="id_santri" value="<?= $sikap->id_santri ?>" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
